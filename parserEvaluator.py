...
print "wrongTranslate: " + str(wrongTranslate)
print "correct translation: " + str(testSentences - wrongTranslate)
print "TranslateParse: " + str(TranslateParse)
print "testSentences: " + str(testSentences)
